...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-9.06664546490560829817e-01) <= d_delta <= 4.07999045920752367866e-01);
    DifferentialEquation acadodata_f3;
    acadodata_f3 << dot(vx) == r*vy;
    acadodata_f3 << dot(vy) == ((-1/1.38000000000000000000e+03*3.10000000000000000000e+05/vx)*vy+1.01060000000000000000e+05/1.38000000000000000000e+03*r/vx+1.20000000000000000000e+05/1.38000000000000000000e+03*delta);
    acadodata_f3 << dot(r) == (1.01060000000000000000e+05/2.63450000000000000000e+03/vx*vy-1/2.63450000000000000000e+03*6.05453560000000055879e+05*r/vx);
